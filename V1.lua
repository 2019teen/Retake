...
-- local toggle = Library:CreateToggle(miscVisualsSection, {
-- 	name = "FOV Circle",
-- 	default = false,
-- 	flag = "visuals_fov_circle"
-- })

-- toggle:CreateColorPicker({
...
-- 	name = "notify",
-- 	callback = function()
--         Library:Notify("Retake.win successfully loaded!", math.random(1,5))
--     end
-- })
